      ...
      <Card className="glass-card rounded-[20px] overflow-hidden border border-white/[0.06] bg-white/[0.04] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.06)]">
        <div className="px-8 pt-8 pb-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-[#9CA3AF] font-light">Real-time AI optimization actions</p>
          </div>
        </div>
      ...
      <Card className="glass-card rounded-[20px] overflow-hidden border border-white/[0.06] bg-white/[0.04] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.06)]">
        <div className="px-8 pt-8 pb-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-[#9CA3AF] font-light">Recent deposits and withdrawals</p>
          </div>
        </div>
        <div className="p-8 pt-0">
          <VaultActivityTicker />
